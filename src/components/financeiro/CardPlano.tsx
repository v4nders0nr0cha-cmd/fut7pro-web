...
export default function CardPlano({
  ...
  return (
    <div
      className="flex flex-col gap-2 rounded-2xl border-l-8 bg-zinc-800 p-4 shadow"
    ...
    >
      ...
      <div className="mt-2 flex flex-wrap gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span
            className={`font-bold ${inadimplentes > 0 ? "cursor-pointer text-red-400 underline" : "text-green-400"}`}
            ...
            onKeyDown={
              inadimplentes > 0
                ? (e) => e.key === "Enter" && onClickInadimplentes?.()
                : undefined
            }
