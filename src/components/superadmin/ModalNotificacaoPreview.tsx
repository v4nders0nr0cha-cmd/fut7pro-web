...
export const ModalNotificacaoPreview: FC<ModalNotificacaoPreviewProps> = ({ notificacao, onClose }) => (
    ...
    <div className="bg-zinc-900 rounded-xl p-6 w-full max-w-md shadow-xl">
      ...
      <div className="mb-4 space-y-2 text-zinc-100">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs text-zinc-400">
          <span><b>Destino:</b> {notificacao.destino}</span>
          <span><b>Status:</b> {notificacao.status}</span>
          <span><b>Tipo:</b> {notificacao.tipo}</span>
          <span><b>Enviado por:</b> {notificacao.enviadoPor}</span>
        </div>
