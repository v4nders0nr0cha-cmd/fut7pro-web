      ...
      try {
        ...
        setParticipantes((prev) =>
          prev.map((participante) => ({
            ...participante,
            estrelas: estrelasMap[participante.id] ?? createDefaultEstrela(rachaId, participante.id),
          }))
        );
      } catch (error) {
      ...
      if (participanteOriginal) {
        ...
        setParticipantes([
...

          {
            ...
            estrelas:
              estrelasGlobais[participanteOriginal.id] ?? createDefaultEstrela(rachaId, participanteOriginal.id),
