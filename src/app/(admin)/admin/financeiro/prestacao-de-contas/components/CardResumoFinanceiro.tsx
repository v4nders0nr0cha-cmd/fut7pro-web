  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
      <div className="bg-neutral-800 rounded-lg p-5 flex flex-col items-center shadow-sm">
        ...
        <span className="text-green-400 font-bold text-xl">{formatCurrency(receitas)}</span>
      </div>
      <div className="bg-neutral-800 rounded-lg p-5 flex flex-col items-center shadow-sm">
        <span className="text-gray-400 text-xs mb-1">Despesas</span>
        <span className="text-red-400 font-bold text-xl">{formatCurrency(despesas)}</span>
      </div>
      <div className="bg-neutral-900 border border-yellow-500 rounded-lg p-5 flex flex-col items-center shadow-lg">
        ...
        <span className="text-yellow-300 font-extrabold text-xl">{formatCurrency(saldoAtual)}</span>
      </div>
    </div>
  );
}
