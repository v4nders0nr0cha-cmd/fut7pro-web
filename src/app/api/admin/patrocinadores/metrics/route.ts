...
const ALLOWED_PARAMS = new Set(["start", "end", "granularity", "tier", "sponsorId"]);
...
export async function GET(req: NextRequest) {
  ...
  const backendUrl = new URL("/sponsors/metrics", getApiBase());
  ...
  try {
    ...
    if (!backendResponse.ok) {
      ...
      try {
        ...
        return toJson(
          {
            error: "Falha ao consultar metricas de patrocinadores",
