export const metadata = {
  ...
  description:
    "Veja comunicados e avisos fixos publicados pela administração do seu racha.",
      ...
      <ul className="space-y-4">
        ...
        {comunicadosMock
          ...
          .map((com) => (
            <li
              key={com.id}
              className="rounded-lg border-l-4 border-yellow-400 bg-zinc-800 p-4 text-zinc-100"
            >
