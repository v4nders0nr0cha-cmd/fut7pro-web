  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-1 pt-[40px] pb-10">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-yellow-400 mb-2">🏆 Os Campeões</h1>
      ...
      {campeoes.length === 0 ? (
        <div className="bg-[#1A1A1A] rounded-2xl p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Nenhum campeão registrado</h2>
          <p className="text-textoSuave">Ainda não há campeões registrados no sistema.</p>
        </div>
      ) : (
