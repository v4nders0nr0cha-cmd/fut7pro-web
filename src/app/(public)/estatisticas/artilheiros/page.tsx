    ...
    <>
      ...
      <main className="min-h-screen w-full bg-fundo pb-16 pt-6 text-white">
        <h1 className="sr-only">
          Ranking dos Artilheiros do Racha de Futebol 7 – Jogadores com Mais
          Gols, Estatísticas
        </h1>
        ...
        <div className="flex w-full flex-col items-center justify-center">
          ...
          <div className="flex w-full max-w-3xl flex-col items-center">
            ...
            <p className="mb-3 max-w-xl text-center text-sm text-gray-400">
              Confira quem balançou mais as redes e compare o desempenho por
              quadrimestre, na temporada atual ou em todas as temporadas do
              Racha.
