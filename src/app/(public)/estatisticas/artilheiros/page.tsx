...
export default function RankingArtilheirosPage() {
  ...
  const { format, setFormat, exporting, feedback, setFeedback, handleExport } = useRankingExport({
    ...
    type: "artilheiros",
    limit: 100,
    filenamePrefix: "ranking-artilheiros",
  });
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Ranking oficial dos artilheiros do Fut7Pro. Veja quem marcou mais gols na temporada e acompanhe a disputa rodada a rodada."
        />
        <meta
          name="keywords"
          content="ranking artilheiros, Fut7Pro, futebol 7, estatisticas, gols, jogadores, racha"
        />
      </Head>

      <main className="min-h-screen bg-fundo text-white pb-16 pt-8 w-full">
        <h1 className="sr-only">
          Ranking dos Artilheiros do Racha de Futebol 7 - Jogadores com Mais Gols
        </h1>
        ...
        <section className="w-full max-w-4xl mx-auto px-4 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-gray-400 mb-5 max-w-2xl">
            Lista atualizada automaticamente com os atletas que mais balancaram as redes no seu
            racha. Digite o nome do jogador para encontra-lo rapidamente ou role para conferir o Top
            100.
          </p>
          ...
          <div className="w-full sm:w-80">
            <input
              ...
              aria-label="Buscar atleta por nome no ranking de artilheiros"
            />
          </div>
        ...
        <section className="px-4 mt-6">
          <PlayerRankingTable
            ...
            error={error ?? null}
            highlight="gols"
            emptyMessage="Nenhum artilheiro encontrado para o filtro informado."
          />
        </section>
      </main>
    </>
