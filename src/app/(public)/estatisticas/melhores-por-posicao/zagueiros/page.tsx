...
export default function RankingZagueirosPage() {
  ...
  const { rankings, isLoading, isError, error } = usePublicPlayerRankings(
    periodo === "temporada"
      ? { slug: publicSlug, type: "geral", period: "year", year: anoAtual, position: "zagueiro" }
      : periodo === "todas"
        ? { slug: publicSlug, type: "geral", period: "all", position: "zagueiro" }
        : {
            slug: publicSlug,
            type: "geral",
            period: "quarter",
  ...
  return (
    <>
      <Head>
        <title>Ranking dos Melhores Zagueiros | Estat�sticas</title>
        <meta
          name="description"
          content="Veja o ranking dos zagueiros mais bem pontuados do seu racha, por quadrimestre, temporada atual ou hist�rico completo. Descubra quem s�o os destaques na posi��o!"
        />
        <meta
          name="keywords"
          content="Ranking Zagueiros, Melhores Zagueiros, Estat�sticas, Temporada Atual, Todas as Temporadas, Racha, Futebol 7"
        />
      </Head>
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <div className="w-full max-w-3xl flex flex-col items-center">
            ...
            <p className="text-center text-sm text-gray-400 mb-3 max-w-xl">
              ...
              filtrar os defensores mais pontuados na posi��o!
            </p>
        ...
        <div className="w-full overflow-x-auto scrollbar-dark">
          {isLoading && (
            <div className="text-center text-gray-400 py-8">
              Carregando ranking dos zagueiros...
            </div>
          )}
          {isError && !isLoading && (
            <div className="text-center text-red-400 py-8">
              Erro ao carregar ranking dos zagueiros.
