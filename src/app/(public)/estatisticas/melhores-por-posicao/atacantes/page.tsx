...
export default function RankingAtacantesPage() {
  ...
  const { rankings, isLoading, isError, error } = usePublicPlayerRankings(
    periodo === "temporada"
      ...
      : periodo === "todas"
        ? { slug: publicSlug, type: "geral", period: "all", position: "atacante" }
        : {
            slug: publicSlug,
            type: "geral",
            period: "quarter",
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <div className="w-full max-w-3xl flex flex-col items-center">
            <PageHelp
              ...
              summary="Atacantes mais pontuados por período, temporada ou histórico completo."
              detailsTitle="Como funciona o ranking de atacantes"
              details={
                <>
                  <p>
                    Esta lista compara apenas atletas cadastrados como atacantes, destacando quem
                    mais pontuou na função.
                  </p>
                  <p>
                    Use o período para alternar entre quadrimestres, temporada atual e histórico
                    completo. A busca encontra rapidamente um atacante pelo nome.
                  </p>
                </>
              }
            />
        ...
        <div className="w-full overflow-x-auto scrollbar-dark">
          {isLoading && (
            <div className="text-center text-gray-400 py-8">
              Carregando ranking dos atacantes...
            </div>
          )}
          {isError && !isLoading && (
            <div className="text-center text-red-400 py-8">
              Erro ao carregar ranking dos atacantes.
