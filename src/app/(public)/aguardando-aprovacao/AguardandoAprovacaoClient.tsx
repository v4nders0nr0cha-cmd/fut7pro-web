  ...
  return (
    <section className="w-full px-4">
      <div className="mx-auto w-full max-w-xl rounded-2xl border border-white/10 bg-[#0f1118] p-6 text-center shadow-2xl">
        ...
        <h1 className="text-xl font-bold text-white">Solicitacao enviada</h1>
        <p className="mt-2 text-sm text-gray-300">
          Seu cadastro esta em analise. O administrador precisa aprovar o acesso completo ao racha.
        </p>
        <p className="mt-3 text-xs text-gray-400">
          Quando a aprovacao for concluida, voce podera acessar o perfil completo e os rankings.
        </p>
