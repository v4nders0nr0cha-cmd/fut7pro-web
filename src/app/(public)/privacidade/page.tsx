  ...
  return (
    <main className="container mx-auto px-4 py-8 prose prose-invert">
      ...
      <p>
        ...
        texto revisado juridicamente antes do go-live.
      </p>
      <h2>Coleta e Uso de Dados</h2>
      <p>
        Coletamos dados mínimos necessários para operar o serviço. Consulte o
        administrador para a lista completa de finalidades e bases legais.
      </p>
      <h2>Cookies</h2>
      <p>
