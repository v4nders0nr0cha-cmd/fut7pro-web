...
router.get("/superadmin/racha-financeiro/:rachaId", catchAsync(ctrl.getRachaDetalhe));
router.get("/superadmin/financeiro/metrics", catchAsync(ctrl.getMetrics));
router.post("/superadmin/racha-financeiro/:rachaId/financeiros", catchAsync(ctrl.postFinanceiro));
router.patch("/superadmin/racha-financeiro/:rachaId/status", catchAsync(ctrl.patchRachaStatus));
